     ...
     stages{
         ...
         stage('sonar qube'){
             ...
             steps{
                 ...
                 withSonarQubeEnv(credentialsId: 'sonar2') {
                     sh 'mvn org.sonarsource.scanner.maven:sonar-maven-plugin:3.3:sonar'
                    }
                 }
             }
         }
         ...
         stage('copy of war file'){
            ...
            steps{
              ...
              sh 'scp -o StrictHostKeyChecking=no target/*.war  jenkins@10.0.3.203:/home/jenkins/workspace/mygameoflife'
               }
